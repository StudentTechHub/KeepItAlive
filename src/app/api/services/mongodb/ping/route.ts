...
import { processMongoPings } from "@/lib/services/mongodb";
import { db } from "@/lib/db";

/**
 * API route to ping MongoDB services
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Find all MongoDB services that are due for a ping
    ...
    const result = await processMongoPings(services);
 ...
 *   "path": "/api/services/mongodb/ping?batchSize=50"
 * }
 */
